...
{
    EventsTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"EventsCell" forIndexPath:indexPath];
    
    // Configure the cell...
    cell.dayLabel.text = @"12";
    cell.dayofWeekLabel.text = @"Friday";
    cell.monthLabel.text = @"AUG";
    cell.eventTitle.text = @"Rolling in my 64";
